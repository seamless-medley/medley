...
export class BoomBox<R extends BaseRequester, P extends BoomBoxProfile = CrateProfile<BoomBoxTrack>> extends TypedEmitter<BoomBoxEvents<P>> {
  ...
  #requests = new TrackCollection<TrackWithRequester<BoomBoxTrack, R>>('$_requests', undefined, {});
  ...
  forcefullySelectCrate(crateId: string, collection: BoomBoxTrackCollection): boolean {
    return this.#sequencer.forcefullySelectCrate(crateId, collection);
  }
