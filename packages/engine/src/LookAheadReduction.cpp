...
void LookAheadReduction::setDelayTime(float delayTimeInSeconds)
{
    delay = (delayTimeInSeconds > 0.0f) ? delayTimeInSeconds : 0.0f;
...
void LookAheadReduction::prepare(const double newSampleRate, const int newBlockSize)
{
...
void LookAheadReduction::pushSamples(const float* src, const int numSamples)
{
...
void LookAheadReduction::process()
{
...
void LookAheadReduction::readSamples(float* dest, const int numSamples)
{
    int startIndex, blockSize1, blockSize2;
...
inline void LookAheadReduction::getProcessPositions(int startIndex, int numSamples, int& blockSize1, int& blockSize2)
{
    if (numSamples <= 0)
    {
        blockSize1 = 0;
...
inline void LookAheadReduction::getWritePositions(int numSamples, int& startIndex, int& blockSize1, int& blockSize2)
{
...
inline void LookAheadReduction::getReadPositions(int numSamples, int& startIndex, int& blockSize1, int& blockSize2)
{
    const int L = static_cast<int> (buffer.size());
